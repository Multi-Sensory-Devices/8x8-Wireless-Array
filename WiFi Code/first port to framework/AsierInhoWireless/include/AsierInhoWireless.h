#ifndef _ASIER_INHO_WIRELESS
#define _ASIER_INHO_WIRELESS
#include <AsierInhoWireless_Prerequisites.h>
/**
...
namespace AsierInhoWireless {
	class _AsierInhoWireless_Export AsierInhoWirelessBoard {
	protected:
		/**
...
# endif
	...
	_AsierInhoWireless_Export AsierInhoWirelessBoard* createAsierInho();

	void printMessage(const char*);
	void printError(const char*);
	void printWarning(const char*);

	_AsierInhoWireless_Export void RegisterPrintFuncs(void(*p_Message)(const char*), void(*p_Warning)(const char*), void(*p_Error)(const char*));
};
