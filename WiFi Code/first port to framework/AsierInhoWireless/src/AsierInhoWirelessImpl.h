#ifndef _ASIERINHO_WIRELESS_IMPLEMENTATION
#define _ASIERINHO_WIRELESS_IMPLEMENTATION
...
using namespace AsierInhoWireless;
...
class AsierInhoWirelessImpl : public AsierInhoWirelessBoard {
	//ATTRIBUTES:
public:
